export const RANGE_CONFIG = [
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(189, 195, 147, 0.30) 80%, rgba(189, 195, 147, 0.06) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(180, 201, 95, 0.30) 80%, rgba(180, 201, 95, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(149, 197, 88, 0.30) 80%, rgba(149, 197, 88, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(88, 171, 96, 0.30) 80%, rgba(88, 171, 96, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(231, 116, 80, 0.30) 80%, rgba(231, 116, 80, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(255, 151, 90, 0.30) 80%, rgba(255, 118, 38, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(255, 171, 94, 0.30) 80%, rgba(255, 157, 86, 0.03) 100%)',
  ...
  },
  {
    ...
    color: {
      secondary:
        'linear-gradient(180deg, rgba(255, 206, 148, 0.30) 80%, rgba(255, 196, 126, 0.03) 100%)',
